...
# Mav CLI - Command Line Examples
# Demonstrating the new -c and -m flag syntax

echo "🚀 Mav CLI Command Line Examples"
echo ""
...
echo "Command:"
echo 'maverick posts:create -c "Hello World!" -i "twitter-123"'
echo ""

# Example 2: Post with multiple images
echo "📸 Example 2: Post with multiple images"
echo "Command:"
echo 'maverick posts:create \'

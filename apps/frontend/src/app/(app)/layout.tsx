import { SentryComponent } from '@mav/frontend/components/layout/sentry.component';
...
import { PHProvider } from '@mav/react/helpers/posthog';
import UtmSaver from '@mav/helpers/utils/utm.saver';
import { DubAnalytics } from '@mav/frontend/components/layout/dubAnalytics';
import { FacebookComponent } from '@mav/frontend/components/layout/facebook.component';
import { headers } from 'next/headers';
import { headerName } from '@mav/react/translation/i18n.config';
import { HtmlComponent } from '@mav/frontend/components/layout/html.component';
import Script from 'next/script';
// import dynamicLoad from 'next/dynamic';
// const SetTimezone = dynamicLoad(
//   () => import('@mav/frontend/components/layout/set.timezone'),
//   {
//     ssr: false,
//   }
// );
      ...
      >
        ...
        >
          <SentryComponent>
            ...
            <FacebookComponent />
            <Plausible
              domain={!!process.env.IS_GENERAL ? 'mav.com' : 'mav.social'}
            >
              <PHProvider

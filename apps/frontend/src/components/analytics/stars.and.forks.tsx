...
import { StarsAndForksInterface } from '@maverick/frontend/components/analytics/stars.and.forks.interface';
import { Chart } from '@maverick/frontend/components/analytics/chart';
